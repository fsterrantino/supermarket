...
def scroll_products_pages(pages):
    total_products = 0
    while total_products == 0:
        ...
        products_shown_and_total = safe_find_element(products_shown_and_total_xpath, 'xpath')
    ...
    for i in range(pages):
        view_more_button = safe_find_element(view_more_button_xpath, 'xpath')    
